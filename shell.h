...
/**
 * struct passarg - contains pseudo-arguements to pass into a function,
...
/* toem_shloop.c */
int hsh(arg_t *, char **);
int find_builtin(arg_t *);
void find_cmd(arg_t *);
void fork_cmd(arg_t *);

/* toem_parser.c */
int is_cmd(arg_t *, char *);
char *dup_chars(char *, int, int);
char *find_path(arg_t *, char *, char *);
